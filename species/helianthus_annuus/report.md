...
Отдельная строгая фильтрация по монотонности для подсолнечника не применялась. При такой плотности возможны локальные перестановки маркеров и большое число одинаковых или близких cM-значений.