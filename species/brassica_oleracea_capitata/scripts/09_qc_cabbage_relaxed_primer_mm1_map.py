...
input_file = Path("results/cabbage/cabbage_genetic_map.relaxed_primer_mm1.clean.unique.tsv")
out_file = Path("results/cabbage/cabbage_genetic_map.relaxed_primer_mm1.clean.unique.qc.tsv")
