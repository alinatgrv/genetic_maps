# Кукуруза: построение генетической карты
...
В качестве источника использовалась генетическая карта MaizeGDB Genetic 1. Данные были загружены для десяти записей MaizeGDB map records с id 1203637–1203646, соответствующих linkage groups LG1–LG10 / chr1–chr10.
...
Колонки, относящиеся к более старым или другим сборкам, например `B73 RefGen_v3` или `Zm-B73-REFERENCE-GRAMENE-4.0`, не использовались для финальной карты.
...
Для кукурузы была построена генетическая карта на актуальной сборке:
